...
export default function Home() {
  ...
  return (
    <div className="h-screen bg-gradient-to-tr from-sky-50 via-white to-sky-100 flex flex-col justify-between font-sans overflow-hidden">
      ...
      {/* Footer Branding */}
      <footer className="text-center py-4 text-[10px] text-slate-400 font-medium select-none shrink-0 border-t border-slate-100/50 bg-white/50">
