    ...
    <div className="h-screen bg-gradient-to-tr from-sky-50 via-white to-sky-100 flex flex-col justify-between font-sans overflow-hidden">
      ...
      >
        {!isStarted ? (
          ...
          <main className="flex-1 w-full max-w-5xl mx-auto p-4 md:p-6 flex flex-col md:flex-row gap-6 items-stretch justify-center overflow-y-auto md:overflow-hidden h-full">
